...
{
    public sealed class PfooterPainter
    {
        private readonly PFooterDocument _footerDocument;
        ...
        {
            if (_footerDocument == null) return;
            _graphics = graphics;
            PaintMember();
        }

        public PfooterPainter(PFooterDocument footerDocument)
        {
            _footerDocument = footerDocument;
            _footerDocument.ExecuteDocRowPaint = ExecuteDocRowPaint;
            _footerDocument.ExecuteMemberPaint = ExecuteMemberPaint;
        }

        public void PaintMember()
        {
            _footerDocument.Paint();
        }
